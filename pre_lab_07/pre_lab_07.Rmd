...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer** The fastest state growing was Nevada
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer** The Maryland county with the highest meadian household income is Howard County. 
...
Is the difference between Calvert and Montgomery significant? **Answer** Not particularly. As the chart indicates, there is considerable overlap between Calvert and Montgomery counties.

Is the difference between Howard and everyone else significant? **Answer** Yes, Howard County stands out significantly. It is far ahead of the rest, reflecting its status as the wealthiest county.
...
**Answer**Among the top 20 ZIP codes with the highest contribution amounts, none have an estimated median household income below $50,000. In fact, you have to go down to the 54th ZIP code to find one with a median income below $50k.
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **Answer** Since many of the top ZIP codes share the same starting digits, indicating they come from similar regions, my first step would be to verify whether they are from Howard County, which is known to be the wealthiest. Next, I’d like to investigate these areas further by researching their demographics, focusing on the predominant gender and race in these regions.
