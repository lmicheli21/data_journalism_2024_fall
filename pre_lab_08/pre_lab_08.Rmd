...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **Answer** It has 18 rows and 24 columns. 
...
**Task** Complete and run the following code to create a dataframe of top 10 counties with the biggest change in unaffiliated voters in Maryland. In the space below, explain what each step of the code below is doing in English.Run the following code. Explain what you see after running the code in the space below. **Answer** First, we added a new column to our md_voters dataframe to calculate the difference in unaffiliated voter between 2024 and 2022. Next, we created a new dataframe called maryland_top_counties, where we selected the top 10 counties with the largest differences in unaffiliated voter. Lastly, we displayed the results.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Nothing! We can only see a white canva.  
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The code generates a somewhat chaotic bar chart illustrating the change in unaffiliated voters between 2024 and 2022. However, the chart appears rough; for instance, the county names are not easily readable, making it harder to interpret the data clearly. Improvements could be made to enhance readability.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** Through the function reorder we were able to display the counties' bars in a decresceasing order. Now it is more readable. However, we can't still read well the counties' names. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** Thanks to the function "coord_flip()" we were able to flip the axis coordinates. This new display makes the chart more readable as finally we can read the counties' names. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** By adding a theme, through the theme_something() function, we can add or change the background of our charts. In this case, we chose a minimal theme. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** Now we slightly changed the theme_something function requesting to make our chart looks like The Economist patterns. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** from the last codeblock through the function "labs()" we added a title, we labeled the y and x axis and finally added a caption at the bottom of the graph. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The results display the how the number of distributions changed over time, day-by-day. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Now we displayed the precedent results in a line-chart that has the timeframe for the x and the number of contributions for the y. However, the time shown is not detailed as we had it in the results.   
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Now the chart displays a more detailed time-frame. We were able to this through the scale_x_date() function. We sellected to put a mark every week. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Now we changed the layout of the x text (the date) in order to read them better. 
