...
"chr" "dbl". They rapresent the last names' of the contributors and the value of their contribution
...
**Answer** 
It represents the full details for a specific data I asked the system to process. 
...
**Answer**
now we have a decreasing order
...
**Answer**
Now it groups by two different colums (memo_text, amount). It comes out a tibble with three data
...
**Answer**
Now it gives also the total amount of contributes. 
...
**Answer**
Now, in addition to the total amount, we also have the mean amount and the median for each contribute. The top three. The top result remains "Earmarked for TRUMP NATIONAL COMMITTEE JFC, INC. (C00873893)". 
...
In addition to what we had before, this codeblock allows us to see what are the minimum and the meximum amount of contributes in each city. It is sorted by following the alphabetic order of the cities.  